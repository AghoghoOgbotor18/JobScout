        ...
        <>
            ...
            {savedJobs.length === 0 ? (
                ...
                <div className="container mx-auto mt-32 text-center">
                    ...
                    No job fits your description
                    </h1>
                    <p className="text-gray-600 mt-2">
                    Search again using job name or company name.
                    </p>
                </div>
                ) : (
                <div className="container mx-auto my-30 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div
                        key={job.id}
                        className="flex flex-col gap-4 mx-2 border-2 border-green-800 rounded-md bg-green-50 px-4 py-3 hover:-translate-y-0.5 duration-75"
                    >
                        ...
                        <div className="flex justify-between gap-2 items-center">
                            ...
                            <p className="bg-green-200 rounded-md w-fit px-1.5 py-2 text-sm">
                            {job.job_type}
                            </p>
                        </div>

                        <p className="bg-green-200 rounded-lg w-fit px-1.5 text-sm">
                            {job.salary}
                        </p>
                        </div>
