...
const Hero = () => {
    return (
        <div className='flex flex-col sm:flex-col justify-center items-center md:justify-between lg:flex-row gap-4 lg:gap-2 md:px-10 px-3 py-30'>
            <div className='flex flex-col gap-10 lg:gap-7 text-center lg:text-start'>
                <h2 className='font-bold text-5xl sm:text-6xl md:text-7xl capitalize'>Find your dream job in Nigeria</h2>
